...
\begin{align*}
    \braket{Z} &= \braket{\psi(t) | Z | \psi(t)} \\
    &= \cos^2(\theta) \braket{\uparrow | Z | \uparrow} + \sin^2(\theta) \braket{\downarrow | Z | \downarrow} + 2\cos(\theta)\sin(\theta) \braket{\uparrow | Z | \downarrow}
\end{align*}

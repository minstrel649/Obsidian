...
\[
p(\ket{00\cdots 0}) = \lim_{\delta t \to 0} p(S_{n}(0)) = \lim_{\delta t \to 0} \cos^{2[\frac{T}{\delta t}]}(\frac{\mu B \delta t}{\hbar}) = e^{\frac{2T}{\delta t}\ln(cos(\frac{\mu B \delta t}{\hbar}))}\text{~}1
\]
